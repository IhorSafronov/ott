(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const summaryElements = document.querySelectorAll(".spollers__title");
        const handleClick = function() {
            if (this.textContent === "More info") this.textContent = "Hide info"; else this.textContent = "More info";
        };
